  ...
  return (
    <div className="headerWrapper">
      <div className="titleWrapper">
        <h1 className="titleText">2023 인터넷콘텐츠 실습</h1>
      </div>
      <figcaption>2023081073 이진석</figcaption>
      <hr />
    </div>
  );
};
    ...
    <div className="category">
      {data.map((group, index) => (
        <div className="categoryWrapper" key={index}>
          ...
          <div className="categoryLanguages">
            {group.languages.map((language, index) => (
              <span className={"lang-" + language} key={index}>
                {language}{" "}
                {language === "html" ? (
                  <svg
          ...
          <div className="categoryDate">{group.date}</div>
        </div>
      ))}
    </div>
  );
